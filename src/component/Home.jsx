...
const Home = () => {
  return (
    <div id="home" className="bg-greeyyy ">
      <div className="md:px-[130px] px-6 text-center md:text-left pt-[127px] h-screen  md:h-[900px] relative">
        ...
        <a href='http://wa.me/6281311118809' target='blank' className="absolute md:right-[130px] md:bottom-[120px] md:translate-x-0 bottom-10 right-[50%] translate-x-[50%] bg-violet-800 text-white py-3 px-16 rounded-md text-xl font-semibold cursor-pointer" >ORDER NOW</a>
      </div>
    </div>
  );
};
